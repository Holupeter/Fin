              ...
              <div className="flex flex-col items-start gap-6 w-full max-w-[303px] md:max-w-[296px] lg:max-w-[364px] flex-1 lg:flex-none">
                ...
                <div className="flex flex-col items-start gap-4 w-full">
                  ...
                  <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <div className="flex flex-row items-center gap-1 justify-end flex-1 overflow-hidden">
                      <SmartAmount amount={formatCurrency(50)} className="text-preset-3 text-grey-900 text-right" maxWidth={70} />
                      <SmartAmount amount={formatCurrency(50)} prefix="of " className="text-preset-5 text-grey-500" maxWidth={60} />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <div className="flex flex-row items-center gap-1 justify-end flex-1 overflow-hidden">
                      <SmartAmount amount={formatCurrency(250)} className="text-preset-3 text-grey-900 text-right" maxWidth={70} />
                      <SmartAmount amount={formatCurrency(750)} prefix="of " className="text-preset-5 text-grey-500" maxWidth={60} />
                    </div>
                  </div>
                  <div className="w-full h-[1px] bg-grey-100"></div>
                  ...
                  <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <div className="flex flex-row items-center gap-1 justify-end flex-1 overflow-hidden">
                      <SmartAmount amount={formatCurrency(67)} className="text-preset-3 text-grey-900 text-right" maxWidth={70} />
                      <SmartAmount amount={formatCurrency(75)} prefix="of " className="text-preset-5 text-grey-500" maxWidth={60} />
                    </div>
                  </div>
                  <div className="w-full h-[1px] bg-grey-100"></div>
                  ...
                  <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <div className="flex flex-row items-center gap-1 justify-end flex-1 overflow-hidden">
                      <SmartAmount amount={formatCurrency(65)} className="text-preset-3 text-grey-900 text-right" maxWidth={70} />
                      <SmartAmount amount={formatCurrency(100)} prefix="of " className="text-preset-5 text-grey-500" maxWidth={60} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-start p-6 gap-5 w-full bg-white rounded-xl md:p-8">
                ...
                <div className="flex flex-col items-start gap-4 w-full">
                  <div className="flex flex-row items-center gap-1 w-full flex-wrap overflow-hidden">
                    ...
                    <SmartAmount amount={formatCurrency(50)} className="text-preset-4 text-grey-500" />
                  </div>
                  ...
                  <div className="flex flex-row items-center w-full gap-4">
                    <div className="flex flex-row items-center gap-4 flex-1 overflow-hidden">
                      <div className="w-1 h-[43px] bg-green rounded-lg shrink-0"></div>
                      <div className="flex flex-col justify-center gap-1 overflow-hidden">
                        <span className="text-preset-5 text-grey-500">Spent</span>
                        <SmartAmount amount={formatCurrency(50)} className="text-preset-4-bold text-grey-900" />
                      </div>
                    </div>
                    <div className="flex flex-row items-center gap-4 flex-1 overflow-hidden">
                      ...
                      <div className="flex flex-col justify-center gap-1 overflow-hidden">
                        ...
                        <SmartAmount amount={formatCurrency(0)} className="text-preset-4-bold text-grey-900" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col items-start gap-3 w-full">
                    ...
                    <div className="flex flex-row justify-between items-center w-full h-[40px]">
                      ...
                      <div className="flex flex-col justify-center items-end gap-1 overflow-hidden">
                        <SmartAmount amount="-$10.00" className="text-preset-5-bold text-grey-900 text-right" />
                        <span className="text-preset-5 text-grey-500">{new Date(2024, 7, 16, 14, 0).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}, 14:00</span>
                      </div>
                    </div>
